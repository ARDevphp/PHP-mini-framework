...
class AutoCategory extends Model implements SaveToDatabaseInterface
{
    public array $data = [
        'id' => null,
        'name' => null,
    ...
    {
        $sql = "UPDATE onlinemarket.{$this->TableName()} SET name = :name, categoryId = :categoryId where id = :id";
        $state = $this->db->prepare($sql);
