...
foreach ($autoCategoryName as $item) {
    $result = $item->name;
}
        ...
        <div class="col-8 mt-3">
            ...
            <form method="post">
                <div class="input-group">
                    ...
                    <select class="form-select" name='autoCateUpdate' aria-label="Default select example">
                ...
                <div class="col d-flex justify-content-between mt-4">
                    ...
                    <a class="btn btn-danger mb-3" href="/autoCategory/list"> Ortga << </a>
                </div>
            </form>
        </div>
    </div>
