...
<div class="container">
                ...
                <div class="input-group">
                    ...
                    <div class="col-8">
                        <input
                            ...
                            class="form-control"
                            style="height: 39px"
                            placeholder="Auto category name"
                        />
                    </div>
                    <select
                    ...
                    <button type="submit" name="create" class="btn btn-success" style="height: 39px">Create</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="col mt-3">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <th scope="col">#id</th>
                <th scope="col">Auto Category Name</th>
            ...
            foreach ($list as $item) {
                ...
                echo "<td>
                               <a 
                                    href='/autoCategory/update?id=" . $item->id . "' 
                               ...
                               <a
                                href='/autoCategory/delete?id=" . $item->id . "' 
